...
SOURCES = float.c util.ml type.ml id.ml m.ml s.ml \
syntaxPlusPos.mli syntaxPlusPos.ml syntax.ml parser.mly lexer.mll typing.mli typing.ml kNormal.mli kNormal.ml \
